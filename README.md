...
Small, single-purpose lists and tools. Each one is checked automatically and says where its numbers came from.
...
| [ai-coding-field-notes](https://github.com/xyzs996/ai-coding-field-notes) | Write-ups on what AI coding agents cost, where they break, and what shipped. |
| [iptv-doctor](https://github.com/xyzs996/iptv-doctor) | M3U/M3U8 playlist checker and XMLTV EPG fixer. |

Corrections are welcome on any of them — open an issue on the repo in question.
